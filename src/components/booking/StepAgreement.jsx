...
const AGREEMENT_SECTIONS = [
  {
    ...
    body: "Client acknowledges that Pawffeur is a specialized pet transportation and behavioral logistics service. To comply with commercial insurance regulations and maintain a focused, stress-free environment for the animals, no human passengers are permitted to ride in the vehicle during transport.",
  },
  {
    title: "2. Expert Handling & Behavior",
    body: "As a Certified Dog Trainer, the Driver will use professional judgment to ensure the pet's safety. Client must disclose all known behavioral issues, including aggression, high anxiety, or \"escape artist\" tendencies. Pawffeur reserves the right to refuse transport if a pet poses an immediate danger to itself or the handler.",
  },
  {
    title: "3. Health & Vaccinations",
    body: "Client warrants that the pet is in good health and current on all required vaccinations (Rabies, Distemper, Parvovirus, and Bordetella). A copy of the pet's vaccination record must be uploaded to the Pawffeur app prior to pickup.",
  },
  {
    title: "4. Emergency Medical Authorization",
    body: "In the event of a medical emergency during transport, Pawffeur is authorized to seek immediate veterinary care at the nearest available facility. All costs associated with emergency care, including transport to a vet, are the sole responsibility of the Client.",
  },
  {
    title: "5. Liability Waiver",
    body: "Pawffeur utilizes crash-tested crates and industrial-grade securement. However, Client acknowledges the inherent risks of vehicle travel. Client agrees to release Pawffeur from liability for any injury, illness, or death of the pet unless caused by gross negligence or willful misconduct.",
  },
  {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[#6B5B4F]/80 text-sm mt-1">Please read and accept the Pawffeur Pet Transport & Safety Agreement before confirming your ride.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-[#EDF7F0] overflow-hidden">
        <div className="bg-[#1B4332] px-5 py-3 flex items-center gap-2">
          ...
          <span className="text-sm font-bold text-white">Pawffeur: Pet Transport & Safety Agreement</span>
        </div>
      ...
      <label className={`flex items-start gap-3 p-4 rounded-2xl border-2 cursor-pointer transition-all ${
        ...
        <span className="text-sm text-[#1B4332] font-medium leading-relaxed">
          I have read and agree to the Pawffeur Safety Agreement, including the Solo-Pet Transport and Emergency Vet clauses.
        </span>
      </label>
